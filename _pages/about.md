...
- **语言能力**：以良好成绩通过CET4(639)(备考CET6 ing)；常在codeforces上刷题，长时间面对英文题面，具备良好的英语文献阅读和写作能力；在校四学期英语课程均获满绩，其中《英语国家概况》（英语快班大二阶段课程）获得97分的年级最高分
...
# 🔥 News
- *2023.10*: &nbsp;🎉🎉 我在2022-2023学年年度综合素质测评中取得了1/285（0.4%）的成绩排名，并获**国家奖学金**、武汉大学优秀学生甲等奖学金以及武汉大学三好学生. 
...
- **【分布式系统基础知识】分布式系统的细分领域包括但不限于：分布式存储系统/文件系统、分布式计算框架、一致性算法、分布式数据库**
