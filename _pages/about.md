...
# 🔥 News
- *2024.05*: &nbsp;🎉🎉  在第十六届蓝桥杯全国软件和信息技术专业人才大赛个人赛省赛（软件赛，C++ A组） 湖北赛区中荣获**二等奖**
...
# 💻 laboratory
- **<span class="fangsong">一个具备容错和负载均衡的可线性化分片KV存储系统的实现</span>**
...
- **<span class="fangsong">分布式系统基础知识</span>**
...
- <span class="xingkai" style="font-size: 30px;">数据库</span>
  - **<span class="youyuan">【图数据库系统】</span>**<span class="fangsong">CuckooGraph：可拓展且高效的动态图存储</span>
    ...
    - 【我们的方法】待中稿后同步更新
    - 【个人贡献】(1)在rebuttal阶段针对审稿人提出实验数目相对不足的情况下进行补充实验；(2)转战ICDE期间，调研目前为止的SOTA，判断其数据结构是否适合与我们比较（比如有些论文他可能更关注于时间窗口上各个快照的处理等，我就会认为它的主题与我们不匹配，不适合进行比较）；(3)为加快图算法在各个系统上的性能测试，进行了系统无关测试平台的搭建: 具体来说，像sortledton和Spruce使用了GFE这个工具，但需要为每个图系统编写驱动，但我们的时间并不充足，于是我负责屏蔽掉各个图系统之间的差异，对上提供一个统一的抽象的图系统接口，用于运行高级图算法。
    - **本工作已投稿ICDE，扩刊时将获得共同第一作者** <a href="..\docs\proof.jpg">[相关证明文件]</a> &nbsp;|&nbsp;
